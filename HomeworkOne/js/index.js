...
export function runApp() {
    try {
        ...
        console.error("Oooops, the Main Table can't be rendered:", error);
      }
    try {
        renderCategoryTable();
    } catch (error) {
        console.error("Oooops, the Category Table can't be rendered:", error);
    }
    try {
        renderArchiveTable();  
    } catch (error) {
        console.error("Oooops, the Archive Table can't be rendered:", error);
    }
}
